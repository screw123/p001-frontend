...
let DefaultCellRenderer = (a, data) => {
    console.log(a.columnIndex, data)
   if (a.columnIndex == 2) {
    return (
    ...
    render() {
        ...
        return (
            <div>
                ...
                <Grid
                    cellRenderer={(a) => {
                        if (this.props.imageComponent) return this.props.imageComponent(a)
                        else {
                            if (a.columnIndex == 2)
                                // sending the URL_thumbanil link, skipping URL
                                return DefaultCellRenderer(a, this.props.data[a.rowIndex][Object.keys(this.props.data[a.rowIndex])[a.columnIndex+1]])
                            else 
                                return DefaultCellRenderer(a, this.props.data[a.rowIndex][Object.keys(this.props.data[a.rowIndex])[a.columnIndex]])
                        }
                    }}
