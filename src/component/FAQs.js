      ...
      <React.Fragment>
        {
          this.state.FAQs.map((FAQ) => {
            return (<FAQItem handleCheckChieldElement={this.handleCheckChieldElement} {...FAQ} />)
          })
        }
      </React.Fragment>
    )
